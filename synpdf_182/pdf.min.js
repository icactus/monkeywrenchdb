...
!function webpackUniversalModuleDefinition(t, e) {
    ...
    , (__unused_webpack_module,exports,__w_pdfjs_require__)=>{
        ...
        class PDFPageProxy {
            ...
            render({canvasContext: t, viewport: e, intent: i="display", annotationMode: s=_util.AnnotationMode.ENABLE, transform: n=null, background: a=null, optionalContentConfigPromise: r=null, annotationCanvasMap: o=null, pageColors: l=null, printAnnotationStorage: c=null}) {
        ...
        class InternalRenderTask {
            ...
            constructor({callback: t, params: e, objs: i, commonObjs: s, annotationCanvasMap: n, operatorList: a, pageIndex: r, canvasFactory: o, filterFactory: l, useRequestAnimationFrame: c=!1, pdfBug: h=!1, pageColors: d=null}) {
                this.callback = t;
                this.params = e;
                this.objs = i;
                this.commonObjs = s;
    ...
    , (t,e,i)=>{
        ...
        class AnnotationEditor {
            ...
            constructor(t) {
                ...
                const {rotation: e, rawDims: {pageWidth: i, pageHeight: n, pageX: a, pageY: r}} = this.parent.viewport;
                this.rotation = e;
    ...
    , (t,e,i)=>{
        ...
        class AnnotationEditorUIManager {
            ...
            get hcmFilter() {
                return (0,
                s.shadow)(this, "hcmFilter", this.#at ? this.#tt.addHCMFilter(this.#at.foreground, this.#at.background) : "none")
            }
            ...
            #_t() {
                window.addEventListener("keydown", this.#ct, {
                    capture: !0
                })
            }
            #At() {
                window.removeEventListener("keydown", this.#ct, {
                    capture: !0
                })
            }
            #vt() {
            ...
            updateToolbar(t) {
                t !== this.#st && this.#Z.dispatch("switchannotationeditormode", {
                    source: this,
                    mode: t
                })
            }
            ...
            removeEditor(t) {
                this.#q.delete(t.id);
                this.unselect(t);
                t.annotationElementId && this.#Y.has(t.annotationElementId) || this.#$?.remove(t.id)
            }
            ...
            translateSelectedEditors(t, e, i=!1) {
                ...
                this.#ft = setTimeout((()=>{
                    ...
                    this.addCommands({
                        cmd: ()=>{
                            for (const t of a)
                                this.#q.has(t.id) && t.translateInPage(s, n)
                        }
                        ,
                        undo: ()=>{
                            for (const t of a)
        ...
        class DOMFilterFactory extends s.BaseFilterFactory {
            ...
            addHighlightHCMFilter(t, e, i, s) {
                ...
                const getSteps = (t,e,i)=>{
                  ...
                  , u = this.#Ot = this.#Ut(d);
                this.#Ht(u);
                this.#jt(getSteps(c[0], h[0], 5), getSteps(c[1], h[1], 5), getSteps(c[2], h[2], 5), u);
                this.#Nt = `url(#${d})`;
                return this.#Nt
            }
            destroy(t=!1) {
    ...
    , (t,e,i)=>{
        ...
        class CanvasGraphics {
            ...
            _scaleImage(t, e) {
                const i = t.width
                  , s = t.height;
                let n, a, r = Math.max(Math.hypot(e[0], e[1]), 1), o = Math.max(Math.hypot(e[2], e[3]), 1), l = i, c = s, h = "prescale1";
                for (; r > 2 && l > 1 || o > 2 && c > 1; ) {
                    let e = l
                      , i = c;
                    if (r > 2 && l > 1) {
    ...
    , (t,e,i)=>{
        ...
        e.OptionalContentConfig = class OptionalContentConfig {
                ...
                if (null !== t) {
                    ...
                    if ("OFF" === t.baseState)
                        for (const t of this.#te.values())
                            t._setVisible(a, !1);
                    for (const e of t.on)
                        this.#te.get(e)._setVisible(a, !0);
                    for (const e of t.off)
                        this.#te.get(e)._setVisible(a, !1);
            ...
            getGroups() {
                return this.#te.size > 0 ? (0,
                s.objectFromMap)(this.#te) : null
            }
            getGroup(t) {
        ...
        const a = "normal"
          ...
          , h = function() {
            ...
            function encode(e, i, s, a) {
                ...
                const m = new Uint8Array([r >> 24 & 255, r >> 16 & 255, r >> 8 & 255, 255 & r, o >> 24 & 255, o >> 16 & 255, o >> 8 & 255, 255 & o, l, c, 0, 0, 0])
    ...
    , (t,e,i)=>{
        ...
        class AnnotationEditorLayer {
            ...
            constructor({uiManager: t, pageIndex: e, div: i, accessibilityManager: s, annotationLayer: n, viewport: a, l10n: l}) {
            ...
            addInkEditorIfNeeded(t) {
                if (!t && this.#pe.getMode() !== s.AnnotationEditorType.INK)
                    return;
                if (!t)
            ...
            enable() {
                ...
                for (const i of e) {
                    i.hide();
                    if (this.#pe.isDeletedAnnotationElement(i.data.id))
                        continue;
                    if (t.has(i.data.id))
                        continue;
            ...
            render({viewport: t}) {
                this.viewport = t;
                (0,
                l.setLayerDimensions)(this.div, t);
                (0,
                a.bindEvents)(this, this.div, ["dragover", "drop"]);
                for (const t of this.#pe.getEditors(this.pageIndex))
                    this.add(t);
                this.updateMode()
            }
            update({viewport: t}) {
    ...
    , (t,e,i)=>{
        ...
        class FreeTextEditor extends a.AnnotationEditor {
            ...
            constructor(t) {
                ...
                this.#Se = t.color || FreeTextEditor._defaultColor || a.AnnotationEditor._defaultLineColor;
            ...
            get propertiesToUpdate() {
                return [[s.AnnotationEditorParamsType.FREETEXT_SIZE, this.#Ce], [s.AnnotationEditorParamsType.FREETEXT_COLOR, this.#Se]]
            }
            #Te(t) {
                const setFontsize = t=>{
            ...
            getInitialTranslation() {
                ...
                return [-FreeTextEditor._internalPadding * t, -(FreeTextEditor._internalPadding + this.#Ce) * t]
            }
            rebuild() {
                super.rebuild();
            ...
            static deserialize(t, e, i) {
                ...
                if (t instanceof r.FreeTextAnnotationElement) {
                    const {data: {defaultAppearanceData: {fontSize: e, fontColor: i}, rect: a, rotation: r, id: o}, textContent: l, textPosition: c, parent: {page: {pageNumber: h}}} = t;
                    if (!l || 0 === l.length)
                        return null;
                    n = t = {
            ...
            serialize(t=!1) {
                ...
                if (t)
                    return r;
                if (this.annotationElementId && !this.#De(r))
                    return null;
    ...
    , (t,e,i)=>{
        ...
        class AnnotationElement {
            ...
            _createContainer(t) {
                ...
                const {width: h, height: d} = getRectDims(e.rect)
                  , u = s.Util.normalizeRect([e.rect[0], i.view[3] - e.rect[1] + i.view[1], e.rect[2], i.view[3] - e.rect[3] + i.view[1]]);
                ...
                if (this._fieldObjects)
                    t.onclick = ()=>{
                        ...
                        for (const t of r) {
                            ...
                            i && (h.has(i) ? i.dispatchEvent(new Event("resetform")) : (0,
            ...
            render() {
                ...
                if (this.renderForms) {
                    ...
                    if (this.enableScripting && this.hasJSActions) {
                        ...
                        this._setEventListeners(i, [["focus", "Focus"], ["blur", "Blur"], ["mousedown", "Mouse Down"], ["mouseenter", "Mouse Enter"], ["mouseleave", "Mouse Exit"], ["mouseup", "Mouse Up"]], (t=>t.target.value))
                    }
        ...
        class CheckboxWidgetAnnotationElement extends WidgetAnnotationElement {
            ...
            render() {
                ...
                if (this.enableScripting && this.hasJSActions) {
                    ...
                    this._setEventListeners(n, [["change", "Validate"], ["change", "Action"], ["focus", "Focus"], ["blur", "Blur"], ["mousedown", "Mouse Down"], ["mouseenter", "Mouse Enter"], ["mouseleave", "Mouse Exit"], ["mouseup", "Mouse Up"]], (t=>t.target.checked))
                }
        ...
        class ChoiceWidgetAnnotationElement extends WidgetAnnotationElement {
            ...
            render() {
                ...
                if (this.enableScripting && this.hasJSActions) {
                    ...
                    this._setEventListeners(s, [["focus", "Focus"], ["blur", "Blur"], ["mousedown", "Mouse Down"], ["mouseenter", "Mouse Enter"], ["mouseleave", "Mouse Exit"], ["mouseup", "Mouse Up"], ["input", "Action"], ["input", "Validate"]], (t=>t.target.value))
                } else
        ...
        class PopupElement {
            ...
            #Qe = null;
            #Ze = !1;
            constructor({container: t, color: e, elements: i, titleObj: s, modificationDate: a, contentsObj: r, richText: o, parent: l, rect: c, parentRect: h, open: d}) {
                this.#bt = t;
                this.#Qe = s;
                this.#Ge = r;
                this.#Je = o;
            ...
            render() {
                if (this.#Ke)
                    return;
                const {page: {view: t}, viewport: {rawDims: {pageWidth: e, pageHeight: i, pageX: n, pageY: a}}} = this.#Ve
                ...
                if (this.#Se) {
                    ...
                    if (CSS.supports("background-color", "color-mix(in srgb, red 30%, white)"))
                        ...
                        const t = .7;
                        r.style.backgroundColor = s.Util.makeHexColor(...this.#Se.map((e=>Math.floor(t * (255 - e) + e))))
                    }
                }
            ...
            #ze() {
                this.#Ke || this.render();
                if (this.isVisible)
                    this.#Xe && this.#bt.classList.add("focused");
                else {
                    this.#bt.hidden = !1;
        ...
        class FileAttachmentAnnotationElement extends AnnotationElement {
            ...
            render() {
                ...
                this.#ai = t;
                !this.data.popupRef && (this.data.titleObj?.str || this.data.contentsObj?.str || this.data.richText) && this._createPopup();
                this.container.append(t);
                return this.container
            }
            getElementsToTriggerPopup() {
        ...
        class InkEditor extends n.AnnotationEditor {
            ...
            #Ni(t, e, i, s, n, a, r) {
                const o = (e + s) / 2
                  ...
                  , c = (s + a) / 2
                  , h = (n + r) / 2;
                t.bezierCurveTo(o + 2 * (s - o) / 3, l + 2 * (n - l) / 3, c + 2 * (s - c) / 3, h + 2 * (n - h) / 3, c, h)
            }
            #ji() {
            ...
            serialize() {
                ...
                return {
                    ...
                    paths: this.#Xi(this.scaleFactor / this.parentScale, this.translationX, this.translationY, t),
                    pageIndex: this.pageIndex,
                    rect: t,
                    rotation: this.rotation
                }
        ...
        class StampEditor extends s.AnnotationEditor {
            ...
            #os(t) {
                ...
                if (this.#is) {
                    ...
                    n.getContext("2d").drawImage(this.#Yi, 0, 0, this.#Yi.width, this.#Yi.height, 0, 0, i, s);
