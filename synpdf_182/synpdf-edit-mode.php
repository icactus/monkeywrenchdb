...
<!--    <script src="jquery-ui.min.js"></script> -->
    ...
    <script src="synpdf-edit-mode.js"></script>
    <style>
...
<body>
<?php include 'get_pieces_and_composers.php'; ?>
...
<!-- <div class="main-container"> -->
    ...
    <section1>
        ...
        <div id="database-menus-wrapper">
            <div id="database-menus">
                ...
                <form class="inputform" id="addnewcomposerform" action="composers-addnew.php" method="POST">
    ...
    <!--</div> -->
<!-- </div> -->
<script src="edit-mode-tools.js?v=4"></script>
</body>
</html>
