...
<body>
    ...
    <section1>
        ...
        <div id="database-menus-wrapper">
            ...
            <div id="database-menus" style="display:flex; flex-direction:column; gap:8px;">
                <form class="inputform" id="loadScore" method="POST" onsubmit="return false;">
                    <div
                        style="display:flex; flex-direction:column; gap:4px; margin-bottom:10px; width:100%; box-sizing:border-box;">
                        <label for="piece_id1">1) Select Piece to Label</label>
                    ...
                    <div>
                        <button type="button" id="loadBtn" style="width:100%; text-align:center;">Load PDF &
                            Data</button>
                    </div>
                </form>
                <div style="margin-top:20px; text-align:center;">
                    <button type="button" id="export-ml-btn"
