...
<head>
    ...
    <script src="synpdf-full-yubsync2.js?v=50"></script>
    <style>
        html {
            width: 100%;
            height: 100%;
        ...
        <div id="help">
            ...
            <table class="helptbl">
                <tr>
                    ...
                    <td>add a <a href="https://wim.vree.org/js2/readme.html#repeats" target="_blank">repeat mark</a> to the measure</td>
                </tr>
                <tr>
                    <td><b>backspace</b></td>
                    <td>backup one measure: erase current sync point (and all following, if any)</td>
                    <td><b>g</b></td>
                    <td>remove a pair of <a href="https://wim.vree.org/js2/readme.html#repeats" target="_blank">repeat marks</a></td>
                </tr>
                <tr>
                    <td><b>,</b></td>
...
Also works with dropbox. You can load a preload file with the score file button.
            ...
            <ul>
                ...
                <li>If you make a mistake you can press Backspace to try again or manually correct the length of the currently highlighted measure with the ',' and '.' keys. Manual correction is mostly useful between movements for adding an extra second before the first beat. Otherwise, syncing should always happen right on the start of the measure.</li>
            ...
            Starting Sync:
            <ul>
                <li>After loading a youtube video in step 2, click "start sync" (right side) and then click the youtube player to begin.</li>
                <li>Press 'b' a second or so before the first beat to begin syncing and then press 'b' again for each barline. At the final measure, wait several seconds longer than the actual length (if the video allows) and then press 'b' for the final time. This will take you back to the first measure and exit sync mode.</li>
