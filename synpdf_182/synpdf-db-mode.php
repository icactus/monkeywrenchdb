...
<meta name="apple-mobile-web-app-capable" content="yes" />
    ...
    <script src="synpdf-db-mode.js" type="module"></script>
    <style>
html, body { width: 100%; height: 100%; margin: 0px; padding: 0px; background:white; }
...
#notation { flex: 1 1 auto; overflow-y:scroll; overflow-x:auto; position: relative; background: #f8f8f8; }
...
#sync     { position: absolute; right: 0px; top: 0px; font-size: inherit;
...
<!-- <div class="main-container"> -->
        ...
        <div id="buttons">
            ...
            <div id="crediv">
                ...
                <div id="pageNumberField">
                  ...
                  <select id="dropdown" onchange="getMonkeyWrenchDBData(this.value)">
                    <option value="">Select a row</option>
                    </select>
                <p><!-- page coordinate editing section info -->Coordinate logging: <span id="indicator" class="inactive-indicator">OFF</span> Click anywhere on the page to record the coordinates. Press 'q' to toggle the functionality on and off. Press 'c' to copy the coordinates to the clipboard (when functionality is active). </p>
            </div>
        </div>
        <div id="sync">
    ...
    <!--testing grid wrapper </div>  -->
    <!--<div class="notationbox"> -->
        <!--div wrapper 2-->
        
        <div id="notation" style="width:1017px;">
            <canvas id="MyCanvas" width="1000" height="2000"></canvas>
        </div> <!--added width for barline pixel mapping -->
...
<script src="bxs-add-remove-split.js"></script>
</body>
</html>
