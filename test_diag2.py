...
# 1. Re-extract features for test page (using previous script logic)
...
# Train model quickly to get scorer
...
spots_to_check = [
    (0, 521), # User FP: treble E
    (0, 770), # User FP
    (4, 755), # User FN (missed true barline)
    (5, 372), # User FP
    (5, 419)  # User FP
]

print("\n--- Diagnostic Scores for Questionable Spots ---")
