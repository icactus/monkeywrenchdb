...
def run():
    ...
    syncer = AudioSync(sr=44100, hop_length=2048) # Same as production test
    ...
    print(f"\n--- FORWARD MAP (Rec1 -> Rec2) Multiple assignments ---")
