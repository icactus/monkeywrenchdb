...
from run_full_pipeline_web_debug import run_pipeline_custom
...
end1 = float(preset['end1']) if preset.get('end1') else None
offset2 = float(preset['offset2']) if preset.get('offset2') else 0.0
end2 = float(preset['end2']) if preset.get('end2') else None
