...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stripped-synpdf-styles.css?v=55" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=121"></script>
    <script src="stripped-synpdf-extras.js?v=96"></script>
</body>
