...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stripped-synpdf-styles.css?v=50" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=116"></script>
    <script src="stripped-synpdf-extras.js?v=91"></script>
</body>
