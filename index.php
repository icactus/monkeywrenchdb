...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stripped-synpdf-styles.css?v=58" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=134"></script>
    <script src="stripped-synpdf-extras.js?v=107"></script>
</body>
