...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stripped-synpdf-styles.css?v=57" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=123"></script>
    <script src="stripped-synpdf-extras.js?v=98"></script>
</body>
