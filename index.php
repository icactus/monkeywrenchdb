...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stripped-synpdf-styles.css?v=56" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=122"></script>
    <script src="stripped-synpdf-extras.js?v=97"></script>
</body>
