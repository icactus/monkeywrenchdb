...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stripped-synpdf-styles.css?v=52" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=118"></script>
    <script src="stripped-synpdf-extras.js?v=93"></script>
</body>
