...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/stripped-synpdf-styles.css?v=175" />
    ...
    <?php if (isset($_SESSION['user_id']) || $is_share_link): ?>
        <script src="annotation-layer.js?v=42"></script>
    <?php endif; ?>
...
<body>
    ...
    <?php if (isset($_SESSION['user_id'])): ?>
        ...
        gap:6px; align-items:center; border:1px solid rgba(0,0,0,0.08);">
            ...
            <button class="annotation-tool-btn" data-tool="eraser" onclick="setAnnotationTool('eraser')"
                ...
                title="Eraser">
                <img src="assets/img/eraser.svg" width="18" height="18" alt="Eraser">
            </button>
    ...
    <script src="stripped-synpdf.js?v=241"></script>
