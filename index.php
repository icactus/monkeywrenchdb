...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stripped-synpdf-styles.css?v=49" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=113"></script>
    <script src="stripped-synpdf-extras.js?v=88"></script>
</body>
