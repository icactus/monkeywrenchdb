...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stripped-synpdf-styles.css?v=38" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=107"></script>
    <script src="stripped-synpdf-extras.js?v=85"></script>
</body>
