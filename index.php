...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/stripped-synpdf-styles.css?v=258" />
    ...
    <?php if (isset($_SESSION['user_id']) || $is_share_link): ?>
        <script src="js/annotation-layer.js?v=104"></script>
    <?php endif; ?>
    <script>
...
<body>
    ...
    <script src="stripped-synpdf.js?v=302"></script>
    <script src="stripped-synpdf-extras.js?v=255"></script>
    <script>
