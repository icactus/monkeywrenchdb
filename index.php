...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/stripped-synpdf-styles.css?v=157" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=207"></script>
    <script src="stripped-synpdf-extras.js?v=190"></script>
    <script>
