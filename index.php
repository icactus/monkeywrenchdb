...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stripped-synpdf-styles.css?v=53" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=119"></script>
    <script src="stripped-synpdf-extras.js?v=94"></script>
</body>
