...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/stripped-synpdf-styles.css?v=180" />
    ...
    <?php if (isset($_SESSION['user_id']) || $is_share_link): ?>
        <script src="annotation-layer.js?v=56"></script>
    <?php endif; ?>
...
<body>
    ...
    <script src="stripped-synpdf.js?v=247"></script>
