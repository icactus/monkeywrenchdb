...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stripped-synpdf-styles.css?v=34" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=105"></script>
    <script src="stripped-synpdf-extras.js?v=83"></script>
</body>
