...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/stripped-synpdf-styles.css?v=269" />
...
<body<?= $bodyClasses ? ' class="' . htmlspecialchars(implode(' ', $bodyClasses), ENT_QUOTES, 'UTF-8') . '"' : '' ?>>
    ...
    <script src="stripped-synpdf.js?v=318"></script>
    <script src="stripped-synpdf-extras.js?v=275"></script>
    <script>
