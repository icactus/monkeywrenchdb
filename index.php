...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stripped-synpdf-styles.css?v=59" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=164"></script>
    <script src="stripped-synpdf-extras.js?v=126"></script>
</body>
