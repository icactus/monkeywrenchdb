...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stripped-synpdf-styles.css?v=54" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=120"></script>
    <script src="stripped-synpdf-extras.js?v=95"></script>
</body>
