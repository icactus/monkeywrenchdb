...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stripped-synpdf-styles.css?v=60" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=168"></script>
    <script src="stripped-synpdf-extras.js?v=127"></script>
</body>
