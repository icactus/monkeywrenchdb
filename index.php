...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stripped-synpdf-styles.css?v=33" />
...
<body>
    ...
    <script src="stripped-synpdf.js?v=100"></script>
    <script src="stripped-synpdf-extras.js?v=78"></script>
</body>
